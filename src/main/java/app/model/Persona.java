...
public class Persona {
    ...
    // --- Constructor ---
    public Persona(int personaId, String title, String name, int age, String occupation, String education,
                   String location, String language, String disability,
                   String needs, String goals, String skills, String image, String imageCredit) {
